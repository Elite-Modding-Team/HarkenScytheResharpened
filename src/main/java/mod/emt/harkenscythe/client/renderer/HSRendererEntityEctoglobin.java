...
public class HSRendererEntityEctoglobin extends RenderLiving<HSEntityEctoglobin>
{
    ...
    public HSRendererEntityEctoglobin(RenderManager renderManager)
    {
        super(renderManager, new ModelSlime(16), 0.25F);
        this.addLayer(new HSLayerEntityEctoglobinGel(this));
    }
    ...
    public static class Factory implements IRenderFactory<HSEntityEctoglobin>
    {
        ...
        {
            return new HSRendererEntityEctoglobin(manager);
        }
    }
}
