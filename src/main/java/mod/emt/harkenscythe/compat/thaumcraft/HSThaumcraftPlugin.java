...
public class HSThaumcraftPlugin
{
    ...
    public static void registerAspects(AspectRegistryEvent event)
    {
        ...
        proxy.registerObjectTag(new ItemStack(HSItems.bloodweave_hood), new AspectList().add(Aspect.CRAFT, 30).add(Aspect.AVERSION, 30));
        proxy.registerObjectTag(new ItemStack(HSItems.bloodweave_robe), new AspectList().add(Aspect.CRAFT, 50).add(Aspect.AVERSION, 50));
        proxy.registerObjectTag(new ItemStack(HSItems.bloodweave_pants), new AspectList().add(Aspect.CRAFT, 40).add(Aspect.AVERSION, 40));
        proxy.registerObjectTag(new ItemStack(HSItems.bloodweave_shoes), new AspectList().add(Aspect.CRAFT, 20).add(Aspect.AVERSION, 20));
        ...
        proxy.registerObjectTag(new ItemStack(HSItems.dimensional_mirror), new AspectList().add(Aspect.CRYSTAL, 15).add(Aspect.ELDRITCH, 10).add(Aspect.MOTION, 10));
        ...
        proxy.registerObjectTag(new ItemStack(HSItems.soulweave_hood), new AspectList().add(Aspect.CRAFT, 30).add(Aspect.SOUL, 30));
        proxy.registerObjectTag(new ItemStack(HSItems.soulweave_robe), new AspectList().add(Aspect.CRAFT, 50).add(Aspect.SOUL, 50));
        proxy.registerObjectTag(new ItemStack(HSItems.soulweave_pants), new AspectList().add(Aspect.CRAFT, 40).add(Aspect.SOUL, 40));
        proxy.registerObjectTag(new ItemStack(HSItems.soulweave_shoes), new AspectList().add(Aspect.CRAFT, 20).add(Aspect.SOUL, 20));
        ...
        proxy.registerObjectTag(new ItemStack(HSItems.spectral_pickaxe), new AspectList().add(Aspect.METAL, 44).add(Aspect.SOUL, 44).add(Aspect.TOOL, 32));
