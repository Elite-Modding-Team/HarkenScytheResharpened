...
public class HSEventLivingDeath
{
    ...
    {
        if (entity.isChild() || entity.getEntityData().getBoolean("IsSpectral") || entity.getMaxHealth() <= HSConfig.ENTITIES.essenceSoulHealthLimit || entity instanceof HSEntityGlobin || HSEntityBlacklists.isBlacklistedForSoulReaping(entity)) return;
