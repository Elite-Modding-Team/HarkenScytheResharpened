...
public class HSEventLivingDeath
{
    ...
    {
        if (entity.isChild() || entity.getEntityData().getBoolean("IsSpectral") || entity instanceof HSEntityGlobin || HSEntityBlacklists.isBlacklistedForSoulReaping(entity)) return;
