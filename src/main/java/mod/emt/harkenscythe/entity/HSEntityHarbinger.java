...
public class HSEntityHarbinger extends EntityCreature implements IMob
{
    ...
    public void onUpdate()
    {
        ...
        if (this.world.isRemote)
        {
            ...
            {
                this.world.playSound(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D, HSSoundEvents.ENTITY_ESSENCE_SOUL_DESPAWN.getSoundEvent(), this.getSoundCategory(), 0.5F + this.rand.nextFloat(), this.rand.nextFloat() * 0.7F + 0.3F, false);
            }
