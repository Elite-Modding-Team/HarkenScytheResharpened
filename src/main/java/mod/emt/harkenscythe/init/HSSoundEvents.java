...
public enum HSSoundEvents
{
    ...
    BLOCK_BLOOD_ALTAR_SUCCESS("block.blood_altar.enchant"),
    BLOCK_BLOOD_ALTAR_FAIL("block.blood_altar.enchant_fail"),
    ...
    BLOCK_SOUL_ALTAR_SUCCESS("block.soul_altar.enchant"),
    BLOCK_SOUL_ALTAR_FAIL("block.soul_altar.enchant_fail"),
    ...
    ITEM_ESSENCE_BOTTLE("item.essence.bottle"),
