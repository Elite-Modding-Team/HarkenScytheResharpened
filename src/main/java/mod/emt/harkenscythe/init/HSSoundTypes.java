...
public class HSSoundTypes
{
    ...
    public static final SoundType LIVINGMETAL = new SoundType(1.0F, 1.0F, HSSoundEvents.BLOCK_LIVINGMETAL_BREAK, HSSoundEvents.BLOCK_LIVINGMETAL_STEP, HSSoundEvents.BLOCK_LIVINGMETAL_BREAK, HSSoundEvents.BLOCK_LIVINGMETAL_STEP, HSSoundEvents.BLOCK_LIVINGMETAL_STEP);
}
