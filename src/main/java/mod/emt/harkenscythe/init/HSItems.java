    ...
    public static void onRegisterItemsEvent(@Nonnull final RegistryEvent.Register<Item> event)
    {
        ...
        registry.registerAll
            (
                ...
                HSRegistry.setup(new HSToolScythe(ToolMaterial.WOOD, 1.4F, EnumRarity.COMMON, 0.045F), "wooden_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(ToolMaterial.STONE, 1.4F, EnumRarity.COMMON, 0.035F), "stone_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(ToolMaterial.IRON, 1.4F, EnumRarity.COMMON, 0.075F), "iron_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(ToolMaterial.GOLD, 1.4F, EnumRarity.COMMON, 0.15F), "golden_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(ToolMaterial.DIAMOND, 1.4F, EnumRarity.COMMON, 0.1F), "diamond_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(HSMaterials.TOOL_BIOMASS, 1.45F, EnumRarity.UNCOMMON, 0.0F), "biomass_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(HSMaterials.TOOL_LIVINGMETAL, 1.45F, EnumRarity.UNCOMMON, 0.2F), "livingmetal_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(HSMaterials.TOOL_REAPER, 1.5F, EnumRarity.EPIC, 0.25F), "reaper_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolScythe(HSMaterials.TOOL_LADY_HARKEN, 1.5F, EnumRarity.EPIC, 0.25F), "lady_harken_scythe").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(ToolMaterial.WOOD, 1.4F, EnumRarity.COMMON, 0.045F), "wooden_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(ToolMaterial.STONE, 1.4F, EnumRarity.COMMON, 0.035F), "stone_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(ToolMaterial.IRON, 1.4F, EnumRarity.COMMON, 0.075F), "iron_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(ToolMaterial.GOLD, 1.4F, EnumRarity.COMMON, 0.15F), "golden_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(ToolMaterial.DIAMOND, 1.4F, EnumRarity.COMMON, 0.1F), "diamond_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(HSMaterials.TOOL_BIOMASS, 1.45F, EnumRarity.UNCOMMON, 0.0F), "biomass_glaive").setCreativeTab(HarkenScythe.TAB),
                HSRegistry.setup(new HSToolGlaive(HSMaterials.TOOL_LIVINGMETAL, 1.45F, EnumRarity.UNCOMMON, 0.2F), "livingmetal_glaive").setCreativeTab(HarkenScythe.TAB),
                ...
                HSRegistry.setup(new HSItemRefreshTome(), "refresh_tome").setCreativeTab(HarkenScythe.TAB),
